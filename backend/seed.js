...
const seedDatabase = async () => {
	try {
		await mongoose.connect(process.env.MONGODB_URI || 'mongodb://127.0.0.1:27017/terravilla');
		...
		// Insert new data
		await Plot.insertMany(mockPlots);
		await PriceComparison.insertMany(mockPriceComparisons);
