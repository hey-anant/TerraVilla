      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-16">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4">
            <button onClick={() => onViewChange('search')} className="bg-gradient-to-r from-emerald-600 to-teal-600 text-white px-8 py-4 rounded-xl font-medium text-lg hover:from-emerald-700 hover:to-teal-700 transition-all shadow-lg hover:shadow-xl">
              Browse Properties
            </button>
            <button onClick={() => onViewChange('seller')} className="bg-white text-slate-900 border-2 border-slate-200 px-8 py-4 rounded-xl font-medium text-lg hover:border-emerald-600 hover:text-emerald-600 transition-all">
              List Your Property
            </button>
          </div>
        </div>
        ...
        <div className="text-center bg-white p-12 rounded-3xl shadow-xl border border-slate-100">
          ...
          <button onClick={() => onViewChange('search')} className="bg-gradient-to-r from-emerald-600 to-teal-600 text-white px-10 py-4 rounded-xl font-medium text-lg hover:from-emerald-700 hover:to-teal-700 transition-all shadow-lg hover:shadow-xl inline-flex items-center space-x-2">
